...
/*
Class Climate Online Surveys - Moodle Block
...
$string['pluginname'] = 'Evaluations (Class Climate)';
...
$string['communication_interface_description'] = 'Moodle and Class Climate can communicate via LTI or via SOAP. Depending on the communication channel selected here, please do your further settings in the corresponding section below.';
$string['soap'] = 'SOAP';
$string['lti'] = 'LTI';

// #8984
$string['presentation'] = 'Display mode';
$string['presentation_description'] = 'In compact mode, the Class Climate Block displays the number of open surveys by means of a graphic. In detailed mode, a list of available surveys is displayed. In both modes, an enlarged list view can be opened upon mouse click.';
...
$string['survey_hide_empty_description'] = 'If activated, the Class Climate block is hidden when the user has no open surveys.';
// END #8977
...
$string['customfieldnumberinevasys'] = 'Custom field in Class Climate';
$string['customfieldnumberinevasys_description'] = 'When using the login name as identifier you can specifiy, which of the first three custom fields in Class Climate should be used for authentication.';
...
$string['survey_server'] = 'Class Climate server (SOAP)';
$string['survey_server_description'] = '';

$string['survey_login'] = 'Class Climate path for online surveys (SOAP)';
$string['survey_login_description'] = '';

$string['survey_user'] = 'Class Climate SOAP user';
$string['survey_user_description'] = '';

$string['survey_pwd'] = 'Class Climate SOAP password';
$string['survey_pwd_description'] = '';

$string['soap_request_eachtime'] = 'SOAP request at pageview';
$string['soap_request_eachtime_description'] = 'If activated, the content of the Class Climate Block will be updated each time the user opens the starting page. If not activated, the block is only updated upon login / at the beginning of the session.';
...
a specific resource from the provider. Each parameter should be entered on a separate line using a format of "name=value"; for example, "learner_show_completed_surveys=1". For further information please refer to the Class Climate LTI Manual.';

// lti_regard_coursecontext is not yet supported by Class Climate LTI provider -> kept for future
...
// capabilities
$string['onlinesurvey:addinstance'] = 'Add instance of the Evaluations (Class Climate) block';
$string['onlinesurvey:myaddinstance'] = 'Add instance of the Evaluations (Class Climate) block to my page';
$string['onlinesurvey:view'] = 'View Evaluations (Class Climate) block';
$string['onlinesurvey:view_debugdetails'] = 'View debug details';
// END: capabilities

// Block content
$string['tech_error'] = 'A technical problem occured while connecting to Class Climate.<p>';
$string['conn_works'] = 'Connection to Class Climate server tested successfully.<p>';
// #8977
...
$string['survey_server_missing'] = 'URL for Class Climate server missing';
