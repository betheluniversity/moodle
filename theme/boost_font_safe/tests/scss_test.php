...
/**
 * This file contains the unittests for boost_font_safe's scss compilation.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_boost_font_safe_scss_testcase extends advanced_testcase {
    /**
     * Test that boost_font_safe can be compiled using SassC (the defacto implemention).
     */
    public function test_scss_compilation_with_sassc() {
        ...
        $this->assertNotEmpty(
            theme_config::load('boost_font_safe')->get_css_content_debug('scss', null, null)
        );
    }
}
