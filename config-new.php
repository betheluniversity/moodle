...
$CFG->dbhost    = 'moodledev-20180205.cpxu0frrf8e8.us-east-1.rds.amazonaws.com';  // eg 'localhost' or 'db.isp.com' or IP
$CFG->dbname    = 'moodle_dev';     // database name, eg moodle
$CFG->dbuser    = 'moodle_admin';   // your database username
$CFG->dbpass    = 'wZGFUYXb8RWUfY76MB3G';   // your database password
