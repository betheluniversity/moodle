...
$string['pluginname'] = 'Evaluationen (Class Climate)';
...
$string['communication_interface_description'] = 'Die Kommunikation mit Class Climate kann per LTI oder SOAP erfolgen. Bitte nehmen Sie im unteren Bereich dieser Maske die notwendigen Einstellungen für den hier gewählten Kommunikationsweg vor.';
$string['soap'] = 'SOAP';
$string['lti'] = 'LTI';
...
$string['customfieldnumberinevasys'] = 'Benutzerdatenfeld in Class Climate';
$string['customfieldnumberinevasys_description'] = 'Bei Verwendung des Nutzernamens als Identifikator können Sie hier festlegen, welches der ersten drei Class Climate-Benutzerdatenfelder zur Authentifizierung verwendet werden soll.';
...
$string['survey_hide_empty_description'] = 'Wenn aktiviert, wird der Class Climate-Block ausgeblendet sofern keine Umfragen für den Nutzer vorhanden sind.';
// END #8977
...
$string['survey_login'] = 'Class Climate Pfad f&uuml;r Onlineumfragen (SOAP)';
$string['survey_login_description'] = '';

$string['survey_user'] = 'Class Climate SOAP-Benutzername';
$string['survey_user_description'] = '';

$string['survey_pwd'] = 'Class Climate SOAP-Kennwort';
...
// capabilities
$string['onlinesurvey:addinstance'] = 'Instanz des Blocks Evaluationen (Class Climate) hinzufügen';
$string['onlinesurvey:myaddinstance'] = 'Instanz des Blocks Evaluationen (Class Climate) zu meiner Seite hinzufügen';
$string['onlinesurvey:view'] = 'Block Evaluationen (Class Climate) anzeigen';
$string['onlinesurvey:view_debugdetails'] = 'Debug-Details anzeigen';
// END: capabilities

// Block content
$string['tech_error'] = 'Es besteht ein technisches Problem mit dem Class Climate Server.<p>';
$string['conn_works'] = 'Verbindung zum Class Climate-Server erfolgreich getestet.<p>';
...
$string['survey_server_missing'] = 'URL des Class Climate Servers fehlt';
