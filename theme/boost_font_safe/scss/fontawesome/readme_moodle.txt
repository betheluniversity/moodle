...
2. SCSS. Replace the SCSS in this folder (/theme/boost_font_safe/scss/fontawesome). Update theme/boost_font_safe/thirdpartylibs.xml. Keep the moodle-paths.scss
