...
/**
 * Privacy tests for theme_boost_custom.
 *
...
use \theme_boost_custom\privacy\provider;

/**
 * Unit tests for theme_boost_custom/classes/privacy/policy
 *
 * @copyright  2018 Adrian Greeve <adriangreeve.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_boost_custom_privacy_testcase extends \core_privacy\tests\provider_testcase {
    ...
    public function test_export_user_preferences() {
        ...
        $exportedpreferences = $writer->get_user_preferences('theme_boost_custom');
        $this->assertCount(1, (array) $exportedpreferences);
        $this->assertEquals('false', $exportedpreferences->{provider::DRAWER_OPEN_NAV}->value);
        $this->assertEquals(get_string('privacy:drawernavclosed', 'theme_boost_custom'),
        ...
        $this->assertEquals(get_string('privacy:drawernavopen', 'theme_boost_custom'),
                $exportedpreferences->{provider::DRAWER_OPEN_NAV}->description);
    }
}
