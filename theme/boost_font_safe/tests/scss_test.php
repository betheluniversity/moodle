...
/**
 * This file contains the unittests for boost_bethel's scss compilation.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_boost_bethel_scss_testcase extends advanced_testcase {
    /**
     * Test that boost_bethel can be compiled using SassC (the defacto implemention).
     */
    public function test_scss_compilation_with_sassc() {
        ...
        $this->assertNotEmpty(
            theme_config::load('boost_bethel')->get_css_content_debug('scss', null, null)
        );
    }
}
